...
const GITHUB_REPO = 'jk-zhang-meta/berth'
// Canonical GHCR image published by this repository (tags carry no "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/jk-zhang-meta/berth'
