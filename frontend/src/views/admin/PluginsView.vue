            ...
            <div>
              ...
              >
                ...
                <dd class="font-mono text-gray-800 dark:text-gray-200">
                  {{ plugin.compatibility.current_berth_version }}
                </dd>
                <dt class="text-gray-500">
                  {{ t("admin.plugins.requiredVersion") }}
                </dt>
                <dd class="font-mono text-gray-800 dark:text-gray-200">
                  {{ plugin.compatibility.required_berth_version }}
                </dd>
                <dt class="text-gray-500">
                  {{ t("admin.plugins.recommendedVersion") }}
                </dt>
                <dd class="font-mono text-gray-800 dark:text-gray-200">
                  {{ plugin.compatibility.recommended_berth_version || "-" }}
                </dd>
              </dl>
            </div>
...
async function handleBridgeMessage(event: MessageEvent): Promise<void> {
  ...
  if (
    !message ||
    message.source !== "berth-plugin-ui" ||
