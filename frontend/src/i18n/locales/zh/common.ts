export default {
  ...
  sessions: {
    title: '会话管理',
    description: '查看 AGS Agent 会话、用量、持续更新的主题总结，以及每个会话的账户优先队列。',
    active: '活跃',
    ended: '已结束',
    totalCost: '总成本',
    sessionId: '会话 ID',
    ...
    topic: '主题总结',
    accounts: '账户',
    noDescription: '暂时还没有主题总结',
    autoSchedule: '自动调度',
    currentAccount: '当前 / 最近账户',
    assignAccounts: '指定账户',
    queueHint: 'Berth 会按这个顺序优先尝试账户。并发和 RPM 始终是硬上限；某个账户满载时会继续尝试下一个可用账户。',
    autoScheduleHint: '未指定优先账户，将按正常账户优先级从可用池中调度。',
    addAccount: '添加账户',
    chooseAccount: '选择账户',
    unavailable: '当前不可用',
  },
