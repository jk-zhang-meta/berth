export default {
  ...
  sessions: {
    title: 'Sessions',
    description: 'Track AGS agent sessions, usage, live topic summaries, and per-session account preference.',
    active: 'Active',
    ended: 'Ended',
    ...
    topic: 'Topic summary',
    accounts: 'Accounts',
    noDescription: 'No topic summary yet',
    autoSchedule: 'Automatic scheduling',
    currentAccount: 'Current / last account',
    assignAccounts: 'Assign accounts',
    queueHint: 'Accounts are tried in this order. Hard concurrency and RPM limits still apply; if one is full, Berth tries the next eligible account.',
    autoScheduleHint: 'No preferred accounts. The normal account priority scheduler chooses from the eligible pool.',
