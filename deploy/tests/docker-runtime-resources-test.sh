...
assert_line Dockerfile.goreleaser 'COPY --chown=berth:berth backend/resources /app/resources'
assert_line deploy/Dockerfile 'COPY --from=backend-builder --chown=berth:berth /app/backend/resources /app/resources'
