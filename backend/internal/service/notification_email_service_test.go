...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "Berth", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "Berth", "https://example.com/reset", "en-US"))
