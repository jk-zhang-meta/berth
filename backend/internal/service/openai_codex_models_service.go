...
const (
	...
	configuredCodexCustomDescription   = "Custom model routed through Berth."
...
func newConfiguredCodexModelDescriptor(modelID string) configuredCodexModelDescriptor {
	...
	if isDeepSeekCodexModel(modelID) {
		...
		descriptor.Description = "DeepSeek coding and reasoning model routed through Berth."
	...
	if isGrokCodexModel(modelID) {
		...
		descriptor.Description = "Grok coding and reasoning model routed through Berth."
		descriptor.SupportsParallelToolCalls = true
	...
	if isClaudeCodexModel(modelID) {
		...
		descriptor.Description = "Claude coding and reasoning model routed through Berth."
		descriptor.SupportsParallelToolCalls = true
	...
	if isOpenAICodexGPTModel(modelID) {
		...
		descriptor.Description = "OpenAI GPT coding model routed through Berth."
		descriptor.SupportsParallelToolCalls = true
