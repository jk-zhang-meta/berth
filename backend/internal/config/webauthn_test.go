	...
	}{
		{
			...
			configure: func(cfg *Config) {
				cfg.WebAuthn = WebAuthnConfig{
					Enabled:       true,
					RPDisplayName: "Berth",
					RPID:          "berth.example.com",
					RPOrigins:     []string{"https://berth.example.com"},
				}
			},
		},
		{
		...
		},
		{
			...
			configure: func(cfg *Config) {
				cfg.WebAuthn = WebAuthnConfig{
					...
					RPDisplayName: "Berth",
					RPID:          "berth.example.com",
					RPOrigins:     []string{"http://berth.example.com"},
				}
			},
