...
func setDefaults() {
	...
	viper.SetDefault("log.service_name", "berth")
	...
	viper.SetDefault("webauthn.rp_display_name", "Berth")
	...
	viper.SetDefault("database.dbname", "berth")
	...
	viper.SetDefault("dashboard_cache.key_prefix", "berth:")
