...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["berth-admin", "jwt.<token>"].
	// - We always select "berth-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"berth-admin"},
}
