...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	rentalStore := service.NewRentalStore(db)
	stewardStore := service.NewStewardStore(db)
	usageService.SetWorkSessions(workSessionStore)
	usageService.SetRentals(rentalStore)
	usageService.SetStewards(stewardStore)
	gatewayService.SetWorkSessions(workSessionStore)
	gatewayService.SetRentals(rentalStore)
	gatewayService.SetStewards(stewardStore)
	openAIGatewayService.SetWorkSessions(workSessionStore)
	openAIGatewayService.SetRentals(rentalStore)
	openAIGatewayService.SetStewards(stewardStore)
